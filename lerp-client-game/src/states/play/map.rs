...
fn spawn_map_chunk(
    ...
    let wall_texture: Handle<Image> = asset_server.load("iso-tileset-wall-cata-160x80.png");
    ...
    let texture_handle: Handle<Image> = asset_server.load("iso-tileset-floor-cata-160x80.png");
...
pub fn render_flow_field(
    ...
    commands.entity(tilemap_entity).insert((
        ...
        TilemapBundle {
            ...
            size: tile_map_size,
            storage: tile_storage,
            texture: TilemapTexture::Single(asset_server.load("iso-tileset-flow-field-32x16.png")),
